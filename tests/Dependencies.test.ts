...
if (Package.dependencies['@types/lodash.merge'] !== 'latest') throw new Error('❌ Error: @types/lodash.merge');
...
if (Package.dependencies['lodash.merge'] !== 'latest') throw new Error('❌ Error: lodash.merge');
